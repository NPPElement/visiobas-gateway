...
#                 if not self._serial_clients.get(
#                     self.serial_port
#                 ) or not self._serial_port_locks.get(self.serial_port):
#                     self._LOG.debug(
#                         "Serial port not using. Creating async client",
#                         extra={
#                             "device_id": self.id,
...
#             self._client.protocol.read_discrete_inputs,  # noqa: E501
#             ModbusReadFunc.READ_HOLDING_REGISTERS:
#             self._client.protocol.read_holding_registers,  # noqa: E501
#             ModbusReadFunc.READ_INPUT_REGISTERS:
#             self._client.protocol.read_input_registers,  # noqa: E501
#         }
#
#     @property
...
#                 resp = await self.read_funcs[obj.func_read](
...
#
#             async with self.lock:
#                 rq = await self.write_funcs[obj.func_write](
#                     obj.address, payload, unit=self.unit  # skip_encode=True,
#                 )
#             if rq.isError():
#                 raise ModbusIOException(str(rq))
#
#             self._LOG.debug(
#                 "Successfully write",
#                 extra={
...
#             )
#
#         except (ModbusException, struct.error, asyncio.TimeoutError, Exception) as e:
#             self._LOG.warning(
#                 "Failed write",
#                 extra={
#                     "device_id": self.id,
