...
from .obj_property_list import ModbusObjPropertyListModel, ModbusPropertyListWrapper
from ..bacnet import ObjProperty, BACnetObjModel


class ModbusObjModel(BACnetObjModel):
    property_list: ModbusPropertyListWrapper = Field(alias=ObjProperty.propertyList.id_str)

    @validator('property_list')
    def parse_property_list(cls, pl: str) -> ModbusObjPropertyListModel:
        return ModbusObjPropertyListModel.parse_raw(pl)
